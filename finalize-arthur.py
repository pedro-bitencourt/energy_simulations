...
name: str = "legacy_thermals" # name of the exercise
...
x_variable: Dict[str, str] = {"name": "legacy_thermal", "label": "Legacy Thermal Capacity"}
# participants should contain all the participants present in the exercise
participants: List[str] = ["solar", "wind", "thermal", "legacy_thermal"]
...
# 
# simulation_name: str = "legacy_thermals"
