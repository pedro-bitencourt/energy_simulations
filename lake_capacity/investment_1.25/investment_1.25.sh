...
#SBATCH --mem=12G
#SBATCH --job-name=investment_1.25
#SBATCH --output=lake_capacity/investment_1.25.out
#SBATCH --error=lake_capacity/investment_1.25.err
...
print('Solving the investment_problem problem investment_1.25')
...
with open('lake_capacity/investment_1.25/investment_1.25_data.json', 'r') as f:
