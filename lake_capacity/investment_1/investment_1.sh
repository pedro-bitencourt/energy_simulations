...
#SBATCH --mem=12G
#SBATCH --job-name=investment_1
#SBATCH --output=lake_capacity/investment_1.out
#SBATCH --error=lake_capacity/investment_1.err
...
print('Solving the investment_problem problem investment_1')
...
with open('lake_capacity/investment_1/investment_1_data.json', 'r') as f:
