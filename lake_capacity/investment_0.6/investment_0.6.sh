...
#SBATCH --mem=12G
#SBATCH --job-name=investment_0.6
#SBATCH --output=lake_capacity/investment_0.6.out
#SBATCH --error=lake_capacity/investment_0.6.err
...
print('Solving the investment_problem problem investment_0.6')
...
with open('lake_capacity/investment_0.6/investment_0.6_data.json', 'r') as f:
