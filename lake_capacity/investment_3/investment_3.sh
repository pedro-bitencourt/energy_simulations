...
#SBATCH --mem=12G
#SBATCH --job-name=investment_3
#SBATCH --output=lake_capacity/investment_3.out
#SBATCH --error=lake_capacity/investment_3.err
...
print('Solving the investment_problem problem investment_3')
...
with open('lake_capacity/investment_3/investment_3_data.json', 'r') as f:
