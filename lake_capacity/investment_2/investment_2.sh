...
#SBATCH --mem=12G
#SBATCH --job-name=investment_2
#SBATCH --output=lake_capacity/investment_2.out
#SBATCH --error=lake_capacity/investment_2.err
...
print('Solving the investment_problem problem investment_2')
...
with open('lake_capacity/investment_2/investment_2_data.json', 'r') as f:
