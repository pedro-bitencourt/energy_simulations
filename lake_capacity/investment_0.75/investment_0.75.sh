...
#SBATCH --mem=12G
#SBATCH --job-name=investment_0.75
#SBATCH --output=lake_capacity/investment_0.75.out
#SBATCH --error=lake_capacity/investment_0.75.err
...
print('Solving the investment_problem problem investment_0.75')
...
with open('lake_capacity/investment_0.75/investment_0.75_data.json', 'r') as f:
