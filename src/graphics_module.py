...
COMPARISON_EVENTS: dict[str, list[dict]] = {
    ...
    'thermal_production': [{'name': 'unconditional', 'label': 'Unconditional'},
        {'name': 'thermal_production_positive', 'label': 'Thermal production > 0'},
    ],
    'hydro_production': [{'name': 'unconditional', 'label': 'Unconditional'},
    {'name': 'hydro_production_positive', 'label': 'Hydro production > 0'},
    ],
}
