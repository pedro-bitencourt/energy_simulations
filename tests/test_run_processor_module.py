...
class TestRun(unittest.TestCase):
    ...
    def test_marginal_cost_df(self):
        dataframe = self.mock_run_processor.marginal_cost_df()
    ...
    def test_construct_random_variables_df(self):
        print('test_construct_random_variables_df')
        dataframe = self.mock_run_processor.construct_random_variables_df()
        self.assertIsNotNone(dataframe)
        print(f'{dataframe.head()=}')

    def test_construct_results_dict(self):
        print('test_construct_results_dict')
        results_dict = self.mock_run_processor.construct_results_dict()
